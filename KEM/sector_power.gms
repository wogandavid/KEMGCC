...
Table ELexist(ELp,v,r,c) existing capacity in GW
                 sout.ksa        west.ksa        east.ksa        cent.ksa
Steam.old        1.658           9.398           10.504          6.081
GT.old           0.50            11.34           12.674          9.339
CC.old           0.588           3.329           3.721           2.154
PV.old
...
Stscrub.old      0               0               0               0
GT.old           0               0               0               0.703
GT.new           0.67            1.93            2.4             0
CC.old           0               0               0               0
CC.new           0               2.38            0               0
PV.old           0.05            0.01            0               0
CSP.old          0               0               0               0
Nuclear.old      0               0               0               0
Wind.old         0               0               0               0
...
Steam.old        0               0               0               0
*Steam.new        0               8.970           0               0
Steam.new        0                               0               0
Stscrub.old      0               0               0               0
GT.old           0.875           0               0               0
*GT.new           0.3765          7.027           0               0
GT.new           0.3765                          0.709           0
CC.old           0               0               0               4.957
*CC.new           2.007           2.262           3.260           0
CC.new           2.007                           0.95            0
PV.old           0               0.01            0               0
CSP.old          0               0               0               0
Nuclear.old      0               0               0               0
...
ELcapital('PV',time,r,c)=ELcapital('PV',time,r,c)*0.5
...
*ELcapital('PSSH','t1',r,c)=5288*1.15;
$offtext
...
Table ELfuelburn(ELp,v,ELf,r,c) fuel burn per GWh (BBL Metric Ton and MMBTU)
* Arablight
              Arablight.(west,sout,cent,east).ksa
Steam.old     1730.1
Steam.new     1647.6
GT.old        2478.1
GT.new        2046.4
...
+             Arablight.(adwe,dewa,sewa,fewa).uae
Steam.old     1730.1
Steam.new     1647.6
GT.old        2478.1
GT.new        2046.4
...
+              Arablight.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
Steam.old      1730.1
Steam.new      1647.6
GT.old         2478.1
GT.new         2046.4
...
* HFO
+                  HFO.(west,sout,cent,east).ksa
Steam.(old,new)    223.6

+                  HFO.(adwe,dewa,sewa,fewa).uae
Steam.(old,new)    223.6

+                  HFO.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
Steam.(old,new)    223.6

* diesel
+                   diesel.west.ksa   diesel.sout.ksa  diesel.cent.ksa   diesel.east.ksa
...
+                   diesel.(adwe,dewa,sewa,fewa).uae
Steam.(old, new)    217
GT.(old, new)       314
CC.old              215
CC.new              152
...
+                   diesel.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
Steam.(old, new)    217
GT.(old, new)       314
CC.old              215
CC.new              152
...
* methane
+                   methane.(west,sout,cent,east).ksa
Steam.(old,new)     8949
GT.old              12818
GT.new              10000
CC.old              8870.6
...
+                   methane.(adwe,dewa,sewa,fewa).uae
Steam.(old,new)     8949
GT.old              12818
GT.new              10000
CC.old              8870.6
...
+                   methane.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
Steam.(old,new)     8949
GT.old              12818
GT.new              10000
CC.old              8870.6
...
* u-235
+                   u-235.(west,sout,cent,east).ksa
Nuclear.(old,new)   120

+                   u-235.(adwe,dewa,sewa,fewa).uae
Nuclear.(old,new)   120

+                   u-235.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
Nuclear.(old,new)   120

* coal
+                    Coal.(west,sout,cent,east).ksa
CoalSteam.(old,new)  376.23

+                    Coal.(adwe,dewa,sewa,fewa).uae
CoalSteam.(old,new)  376.23

+                    Coal.(qatr.qat,kuwr.kuw,bahr.bah,omnr.omn)
CoalSteam.(old,new)  376.23
...
ELgttocc.fx('GTtoCC','old','t1',r,c)=0.1*ELexist('GT','old',r,c);

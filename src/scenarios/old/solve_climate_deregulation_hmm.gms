...
ELbld.up('CoalSteam',v,trun,r,c)=0;
...
fAP('Coal','t02','ksa')=fintlprice('coal','t02')*coalpricegrowth('t02');
...
fAP('HFO','t02','uae')= 1e2;
fAP('Coal','t02','uae')=fintlprice('coal','t02')*coalpricegrowth('t02');
...
fAP('Coal','t03','ksa')=fintlprice('coal','t03')*coalpricegrowth('t03');
...
fAP('HFO','t03','uae')= 1e2;
fAP('Coal','t03','uae')=fintlprice('coal','t03')*coalpricegrowth('t03');
...
ELbld.up('CoalSteam',v,ttrun,r,c)$(ord(ttrun)>3)=0;
...
*ELrenbld.up(ELpsw,vn,trun,r,c)$(ord(trun)>3)=10;

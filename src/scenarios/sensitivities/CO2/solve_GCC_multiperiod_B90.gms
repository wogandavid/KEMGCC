...
EMprice(ksec,EMcp,trun,c)$(ord(trun)=9) = 30;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=10)= 40;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=11)= 50;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=12)= 60;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=13)= 70;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=14)= 80;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=15)= 90;
EMprice(ksec,EMcp,trun,c)$(ord(trun)=16)= 90;

...
*$ontext
if(ord(trun)=6,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p6.gdx";
elseif ord(trun)=7,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p7.gdx";
elseif ord(trun)=8,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p8.gdx";
elseif ord(trun)=9,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p9.gdx";
elseif ord(trun)=10,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p10.gdx";
elseif ord(trun)=11,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p11.gdx";
elseif ord(trun)=12,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p12.gdx";
elseif ord(trun)=13,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p13.gdx";
elseif ord(trun)=14,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p14.gdx";
elseif ord(trun)=15,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p15.gdx";
elseif ord(trun)=16,
        execute_loadpoint "results/Sensitivities/CO2/F30/integratedMCP_p16.gdx";

...
Elcapital('PV','t05',r,c)=1488;
Elcapital('PV','t06',r,c)=1428;
Elcapital('PV','t07',r,c)=1371;
Elcapital('PV','t08',r,c)=1316;
Elcapital('PV','t09',r,c)=1263;
Elcapital('PV','t10',r,c)=1213;
Elcapital('PV','t11',r,c)=1164;
Elcapital('PV','t12',r,c)=1118;
Elcapital('PV','t13',r,c)=1073;
Elcapital('PV','t14',r,c)=1030;
Elcapital('PV','t15',r,c)=989;
Elcapital('PV','t16',r,c)=949;

Elcapital('CSP','t02',r,c)=7706;
Elcapital('CSP','t03',r,c)=7543;
Elcapital('CSP','t04',r,c)=7241;
Elcapital('CSP','t05',r,c)=7088;
Elcapital('CSP','t06',r,c)=6938;
Elcapital('CSP','t07',r,c)=6792;
Elcapital('CSP','t08',r,c)=6648;
Elcapital('CSP','t09',r,c)=6508;
Elcapital('CSP','t10',r,c)=6371;
Elcapital('CSP','t11',r,c)=6236;
Elcapital('CSP','t12',r,c)=6104;
Elcapital('CSP','t13',r,c)=5975;
Elcapital('CSP','t14',r,c)=5849;
Elcapital('CSP','t15',r,c)=5726;
Elcapital('CSP','t16',r,c)=5605;

Elcapital('Wind','t02',r,c)=1528;
Elcapital('Wind','t03',r,c)=1508;
Elcapital('Wind','t04',r,c)=1488;
Elcapital('Wind','t05',r,c)=1421;
Elcapital('Wind','t06',r,c)=1414;
Elcapital('Wind','t07',r,c)=1408;
Elcapital('Wind','t08',r,c)=1402;
Elcapital('Wind','t09',r,c)=1396;
Elcapital('Wind','t10',r,c)=1390;
Elcapital('Wind','t11',r,c)=1384;
Elcapital('Wind','t12',r,c)=1378;
Elcapital('Wind','t13',r,c)=1371;
Elcapital('Wind','t14',r,c)=1365;
Elcapital('Wind','t15',r,c)=1359;
Elcapital('Wind','t16',r,c)=1354;

...
* GCC Interconnector
TRexist('east','ksa','qatr','qat')=1.20*2;
TRexist('east','ksa','adwe','uae')=1.20*2;
TRexist('east','ksa','kuwr','kuw')=1.20*2;
TRexist('east','ksa','bahr','bah')=0.6*2;

*TRexist('adwe','uae','omnr','omn')=0.4;

TRexist('sewa','uae','omnr','omn')=0.4*2;

...
fAP('Coal','t2','ksa')=fintlprice('coal','t2')*coalpricegrowth('t2');
...
fAP('HFO','t2','uae')= 1e2;
fAP('Coal','t2','uae')=fintlprice('coal','t2')*coalpricegrowth('t2');
...
fAP('Coal','t3','ksa')=fintlprice('coal','t3')*coalpricegrowth('t3');
...
fAP('HFO','t3','uae')= 1e2;
fAP('Coal','t3','uae')=fintlprice('coal','t3')*coalpricegrowth('t3');

...
*$ontext
if(ord(trun)=6,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p6.gdx";
elseif ord(trun)=7,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p7.gdx";
elseif ord(trun)=8,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p8.gdx";
elseif ord(trun)=9,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p9.gdx";
elseif ord(trun)=10,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p10.gdx";
elseif ord(trun)=11,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p11.gdx";
elseif ord(trun)=12,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p12.gdx";
elseif ord(trun)=13,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p13.gdx";
elseif ord(trun)=14,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p14.gdx";
elseif ord(trun)=15,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p15.gdx";
elseif ord(trun)=16,
        execute_loadpoint "results/MainScenarios/2020_05_24/G/integratedMCP_p16.gdx";
);
*$offtext
